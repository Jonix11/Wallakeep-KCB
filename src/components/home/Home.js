    ...
    render() {
        return <div>
            <div className="App">
                ...
                <Navbar/>
                {/*1. Aquí se añadiría el error boundary para que si la aplicación sufre un fallo se controle y se muestre un mensaje [LISTO]*/}
                <ErrorBoundary>
                    ...
                    {/*1. Crear la ruta correspondiente a el componente SaleItemFullScreen, para más información ver el componente. [LISTO]*/}
